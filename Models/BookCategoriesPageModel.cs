...
namespace Pavel_Eduard_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel

    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pavel_Eduard_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pavel_Eduard_Lab2Context context,
